...
export default class CInput extends React.Component {
    ...
    isPropsChange(nextProps) {
        const {
            field, rules, readonly, hidden, getFieldValue, type, initVal, inline,
            getFieldError
        } = this.props;
    ...
    render() {
        const {
            label, field, rules, readonly, hidden, getFieldDecorator,
            onChange, type, initVal, inline, title, placeholder
        } = this.props;
