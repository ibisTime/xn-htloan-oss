...
let B44 = 0;
let B46 = 0;
export function exportBOCFjd(data) {
...
function createZxfqsq(wb) {
  ...
  ws['B21'].f = '数据!B23';
  ws['B26'].f = '数据!B12';
  ws['B27'] = {v: moneyReplaceComma(moneyFormat2(B20 * 1000)) + '元', t: 's', w: moneyReplaceComma(moneyFormat2(B20 * 1000)) + '元'};
  ws['B30'] = {v: moneyReplaceComma(moneyFormat2(B44 * 1000)) + '元', t: 's', w: moneyReplaceComma(moneyFormat2(B44 * 1000)) + '元'};
...
// 最新分期申请（背面）
function createZxfqsqBm(wb) {
  var ws = getSheet(wb, 53, 8, '最新分期申请（背面）');
  ws['!merges'] = [{
    e: {c: 4, r: 8},
    s: {c: 2, r: 8}
  }, {
...
function createDbrGthkcns(wb) {
  var ws = getSheet(wb, 48, 8, '担保人共同还款承诺书');
  ws['!merges'] = [{
    e: {c: 7, r: 1},
    s: {c: 4, r: 1}
  }, {
...
function createDbfqfwxy(wb) {
  var ws = getSheet(wb, 48, 8, '担保分期服务协议（有附加费不用打印）');
  ws['!merges'] = [{
    e: {c: 5, r: 20},
    s: {c: 4, r: 20}
  }, {
...
function createSt1(wb) {
  ...
  ws['B11'] = {v: moneyReplaceComma(moneyFormat2(B42)), t: 's', w: moneyReplaceComma(moneyFormat2(B42))};
  ws['B16'].f = '数据!B1';
  ws['C16'].f = '数据!B1';
  ...
  ws['G8'].f = '数据!B1';
  ws['I16'] = {v: moneyReplaceComma(moneyFormat2(B10)) + '元', t: 's', w: moneyReplaceComma(moneyFormat2(B10)) + '元'};
...
function createXht6(wb) {
  ...
  ws['C21'].f = '数据!B18';
  ws['C23'] = {v: moneyReplaceComma(moneyFormat2(B20 * 1000)) + '元', t: 's', w: moneyReplaceComma(moneyFormat2(B20 * 1000)) + '元'};
  ws['E7'] = {v: '㈡', t: 's', w: '㈡'};
  ws['G16'].f = '数据!B2';
  ws['G18'].f = '数据!B16';
  ws['G19'].f = '数据!B17';
...
function createDkqrs(wb) {
  ...
  ws['E10'].f = '数据!B31';
  ws['H5'].f = '数据!B1';
  ws['H8'] = {v: moneyReplaceComma(moneyFormat2(B20 * 1000)) + '元', t: 's', w: moneyReplaceComma(moneyFormat2(B20 * 1000)) + '元'};
  ws['H10'] = {v: moneyReplaceComma(moneyFormat2(B10)) + '元', t: 's', w: moneyReplaceComma(moneyFormat2(B10)) + '元'};
  ws['H12'].f = '数据!B29';
