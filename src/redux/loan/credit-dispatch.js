...
const PREFIX = 'BASIS_CREDIT_DISPATCH_';
...
export function loanCreditDispatch(state = initState, action) {
    switch(action.type) {
        case INIT_STATE:
        ...
        case SET_PAGE_DATA:
            return {...state, pageData: action.payload, isLoaded: true, first: true};
        case RESTORE:
            return {...initState};
        case LOADING:
