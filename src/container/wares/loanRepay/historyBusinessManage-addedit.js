...
import {
  ...
  setPageData,
  restore
} from '@redux/wares/historyBusinessManage-addedit';
import {
  getQueryString
} from 'common/js/util';
import {
...
@DetailWrapper(state => state.waresHistoryBusinessManageAddedit, {
  initStates,
  doFetching,
  cancelFetching,
  setSelectData,
...
class historyBusinessManageAddedit extends React.Component {
  ...
  goDetail(data) {
    this.props.history.push('/wares/historyBusinessManage/addedit/addedit?code=' + data);
  }
  render() {
    const fields = [{
      title: '业务编号',
