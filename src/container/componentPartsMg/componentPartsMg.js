...
class componentPartsMg extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            accessSlipList: [],
    ...
    getAccessSlip = (pageNumber) => {
        ...
        accessSlip(pageNumber, 4, code === '' ? '' : code, customerName === '' ? '' : customerName, curNodeCode === '' ? '' : curNodeCode, ['c1', 'c2']).then(data => {
            let arr = [];
...
export default componentPartsMg;
