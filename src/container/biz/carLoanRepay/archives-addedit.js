      ...
      <Spin spinning={this.state.fetching}>
        <Form>
          <Card title="基本信息">
            ...
            <Row gutter={54}>
              {this.getSelectCol({ field: 'enterFileList', title: '档案目录', multiple: true, keyName: 'id', valueName: '{{no.DATA}}-{{name.DATA}}-{{number.DATA}}份', required: true }, enterFileData, 2)}
              {this.getSelectCol({ field: 'enterLocation', title: '档案存放位置', keyName: 'code', valueName: 'name', readonly: !this.enter, required: true }, enterLocationData, 2)}
            </Row>
          </Card>
          <Card style={{ marginTop: 16 }} title="征信列表">
            {this.getCreditList()}
          </Card>
          <Card style={{ marginTop: 16 }} title="贷款车辆信息">
            <Row gutter={54}>
          ...
          <Card style={{ marginTop: 16 }} title="工作情况">
            ...
            <Row gutter={54}>
              ...
              {this.getSelectCol({ field: 'mainIncome', title: '主要收入来源', keyName: 'dkey', valueName: 'dvalue', multiple: true }, incomeData, 33)}
            </Row>
            <Row gutter={54}>
          ...
          <Card style={{ marginTop: 16 }} title="面签">
            <Row gutter={54}>
          ...
          <Card style={{ marginTop: 16 }} title="财务垫资">
            <Row gutter={54}>
          ...
          <Card style={{ marginTop: 16 }} title="银行放款">
            <Row gutter={54}>
          ...
          <Card style={{ marginTop: 16 }} title="车辆抵押">
            <Row gutter={54}>
              {this.getInputCol({ field: 'pledgeUser', title: '抵押代理人' })}
          ...
          <Card style={{ marginTop: 16 }} title="GPS安装列表">
            {this.getGpsList()}
          </Card>
