    ...
    render() {
        return (
            <div className="afp-body">
                ...
                <Row style={{marginTop: '20px'}}>
                    <Col span={6}>
                        <span>垫资账户户名：xxx汽车经销商</span>
                    </Col>
                    <Col span={6}>
                        <span>垫资账户银行：工商银行城西支行</span>
                    </Col>
                    <Col span={6}>
                        <span>垫资账户账号：88950036892</span>
                    </Col>
                    <Col span={6}></Col>
                </Row>
                <div className="afp-body-line"></div>
                ...
                <Row style={{marginTop: '20px'}}>
                    <Col span={12}>
                        ...
                        <input type="text" className="afp-body-input" />
                    </Col>
                    <Col span={12}></Col>
                </Row>
                <Row style={{marginTop: '20px'}}>
                    <Col span={6}>
                        <span className="afp-body-title">水单：</span><div className="afp-body-card" style={{float: 'left'}}></div>
                    </Col>
                    <Col span={6}></Col>
                    <Col span={6}></Col>
                    <Col span={6}></Col>
