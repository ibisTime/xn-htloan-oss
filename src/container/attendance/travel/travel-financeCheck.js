...
import {
    ...
    setPageData,
    restore
} from '@redux/attendance/travel-financeCheck';
import {
    getQueryString,
    getUserId,
    showSucMsg,
...
@CollapseWrapper(
    state => state.attendanceTravelfinanceCheck, {
        initStates,
        doFetching,
        cancelFetching,
        setSelectData,
...
class TravelfinanceCheck extends React.Component {
    constructor(props) {
        super(props);
...
export default TravelfinanceCheck;
