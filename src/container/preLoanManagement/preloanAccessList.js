...
class preloanAccessList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            accessSlipList: [],
    ...
    componentDidMount() {
        ...
        let btnArr = {
            parentCode: 'SM201805291013406492370',
            ...
            <div className="preLoan-access-list-global">
                ...
                </div>
                {
                    accessSlipList.length <= 0
                        ...
                        : accessSlipList.map((d, index) => {
                            return (<Row className="preLoan-access-list-item" key={index}>
...
export default preloanAccessList;
