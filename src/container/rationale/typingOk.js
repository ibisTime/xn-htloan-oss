...
const {Option} = Select;
class typingOk extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            baseInfo: {},
    ...
    sendSave = () => {
        ...
        let arr = {
            code: this.code,
            hitPieceDatetime: regDate === '' ? getNowTime() : regDate,
            hitPieceNote: iptArr.rmk
        };
        sendTypingOk(arr).then(data => {
            showSucMsg('操作成功');
            setTimeout(() => {
